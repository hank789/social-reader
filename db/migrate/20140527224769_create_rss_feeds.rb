class CreateRssFeeds < ActiveRecord::Migration
  def self.up
    ...
    execute "INSERT INTO rss_feeds (name, url, created_at, updated_at, last_fetched, status) VALUES ('网易头条新闻', 'http://news.163.com/special/00011K6L/rss_newstop.xml',  now(), now(), NOW() - INTERVAL 1 DAY, 1)"
    execute "INSERT INTO rss_feeds (name, url, created_at, updated_at, last_fetched, status) VALUES ('网易国内新闻', 'http://news.163.com/special/00011K6L/rss_gn.xml',  now(), now(), NOW() - INTERVAL 1 DAY, 1)"
    execute "INSERT INTO rss_feeds (name, url, created_at, updated_at, last_fetched, status) VALUES ('网易国际新闻', 'http://news.163.com/special/00011K6L/rss_gj.xml',  now(), now(), NOW() - INTERVAL 1 DAY, 1)"
    ...
    execute "INSERT INTO rss_feeds (name, url, created_at, updated_at, last_fetched, status) VALUES ('新闻国内', 'http://news.qq.com/newsgn/rss_newsgn.xml',  now(), now(), NOW() - INTERVAL 1 DAY, 1)"
    execute "INSERT INTO rss_feeds (name, url, created_at, updated_at, last_fetched, status) VALUES ('新闻国际', 'http://news.qq.com/newsgj/rss_newswj.xml',  now(), now(), NOW() - INTERVAL 1 DAY, 1)"
    execute "INSERT INTO rss_feeds (name, url, created_at, updated_at, last_fetched, status) VALUES ('社会新闻', 'http://news.qq.com/newssh/rss_newssh.xml',  now(), now(), NOW() - INTERVAL 1 DAY, 1)"
    ...
    execute "INSERT INTO rss_feeds (name, url, created_at, updated_at, last_fetched, status) VALUES ('资讯频道_凤凰网', 'http://news.ifeng.com/rss/index.xml',  now(), now(), NOW() - INTERVAL 1 DAY, 1)"
    execute "INSERT INTO rss_feeds (name, url, created_at, updated_at, last_fetched, status) VALUES ('大陆_资讯频道_凤凰网', 'http://news.ifeng.com/rss/mainland.xml',  now(), now(), NOW() - INTERVAL 1 DAY, 1)"
    execute "INSERT INTO rss_feeds (name, url, created_at, updated_at, last_fetched, status) VALUES ('国际_资讯频道_凤凰网', 'http://news.ifeng.com/rss/world.xml',  now(), now(), NOW() - INTERVAL 1 DAY, 1)"
    execute "INSERT INTO rss_feeds (name, url, created_at, updated_at, last_fetched, status) VALUES ('社会_资讯频道_凤凰网', 'http://news.ifeng.com/rss/society.xml',  now(), now(), NOW() - INTERVAL 1 DAY, 1)"
    ...
    execute "INSERT INTO rss_feeds (name, url, created_at, updated_at, last_fetched, status) VALUES ('36氪 | 关注互联网创业', 'http://www.36kr.com/feed',  now(), now(), NOW() - INTERVAL 1 DAY, 1)"
    execute "INSERT INTO rss_feeds (name, url, created_at, updated_at, last_fetched, status) VALUES ('爱范儿 · Beats of Bits', 'http://www.ifanr.com/feed',  now(), now(), NOW() - INTERVAL 1 DAY, 1)"
    execute "INSERT INTO rss_feeds (name, url, created_at, updated_at, last_fetched, status) VALUES ('钛媒体网', 'http://www.tmtpost.com/?feed=rss2&cat=-1204',  now(), now(), NOW() - INTERVAL 1 DAY, 1)"
    execute "INSERT INTO rss_feeds (name, url, created_at, updated_at, last_fetched, status) VALUES ('PingWest中文网', 'http://www.pingwest.com/feed',  now(), now(), NOW() - INTERVAL 1 DAY, 1)"
    ...
    execute "INSERT INTO rss_feeds (name, url, created_at, updated_at, last_fetched, status) VALUES ('CNN.com - Top Stories', 'http://rss.cnn.com/rss/edition.rss',  now(), now(), NOW() - INTERVAL 1 DAY, 1)"
    execute "INSERT INTO rss_feeds (name, url, created_at, updated_at, last_fetched, status) VALUES ('CNN.com - World', 'http://rss.cnn.com/rss/edition_world.rss',  now(), now(), NOW() - INTERVAL 1 DAY, 1)"
    execute "INSERT INTO rss_feeds (name, url, created_at, updated_at, last_fetched, status) VALUES ('nytimes.com - Home Page', 'http://www.nytimes.com/services/xml/rss/nyt/HomePage.xml',  now(), now(), NOW() - INTERVAL 1 DAY, 1)"
    execute "INSERT INTO rss_feeds (name, url, created_at, updated_at, last_fetched, status) VALUES ('nytimes.com - International Home', 'http://www.nytimes.com/services/xml/rss/nyt/InternationalHome.xml',  now(), now(), NOW() - INTERVAL 1 DAY, 1)"
    ...
    execute "INSERT INTO rss_feeds (name, url, created_at, updated_at, last_fetched, status) VALUES ('Hacker News', 'https://news.ycombinator.com/rss',  now(), now(), NOW() - INTERVAL 1 DAY, 1)"
    execute "INSERT INTO rss_feeds (name, url, created_at, updated_at, last_fetched, status) VALUES ('Re/code', 'http://recode.net/feed', now(), now(), NOW() - INTERVAL 1 DAY, 1)"
    execute "INSERT INTO rss_feeds (name, url, created_at, updated_at, last_fetched, status) VALUES ('ReadWrite', 'http://readwrite.com/main/feed/articles.xml', now(), now(), NOW() - INTERVAL 1 DAY, 1)"
